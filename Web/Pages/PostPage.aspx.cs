...
namespace Web.Pages
{
    public partial class PostPage : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            HRFunctions.Instance.InsertNUpdatePOST(obj);
            ClearText();
        ...
        private void LoadEditButton()
        {
            try
            {
                ...
                POST obj = HRFunctions.Instance.Select_POST_ID(idEdit); 
                if (obj != null) 
                {
        ...
        protected void btnDelete_ServerClick(object sender, EventArgs e)
        {
            ...
            if (selected != null && selected.Trim().Length > 0)
            {
                ...
                HRFunctions.Instance.DeletePOST(list);
                Response.Redirect(Request.RawUrl); 
            }
        }
        ...
        private void LoadTimKiem(int pIndex)
        {
            ...
            this.ls = HRFunctions.Instance.POST_Pagination(this.txtKeyword.Value, PageSize, pIndex, out TotalRows);
