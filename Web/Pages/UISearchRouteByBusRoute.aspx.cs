...
namespace Web.Pages
{
    public partial class UISearchRouteByBusRoute : System.Web.UI.Page
    {
        ...
        {
            this.dlStartPosition.DataSource = HRFunctions.Instance.SelectAllBusRoute();
            this.dlStartPosition.DataValueField = "BusRouteID";
            this.dlStartPosition.DataTextField = "RouteName";
        ...
        private void BindingRouteData()
        {
            ...
            this.RepeatRoute.DataSource = HRFunctions.Instance.SearchRouteByBusRouteId(int.Parse(this.dlStartPosition.SelectedValue));
