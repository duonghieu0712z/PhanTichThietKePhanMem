...
namespace Web.Pages
{
    public partial class DocumentClientUI : System.Web.UI.Page
    {
        ...
        private void LoadAllDocument(int pIndex)
        {
            ...
            int TotalRows = 0;
            this.ls = HRFunctions.Instance.FindDocumentByPage(PageSize, pIndex, out TotalRows);
        ...
        private void LoadThLoai(int pIndex)
        {
            int PageSize = int.Parse(this.dlPageNumber.SelectedValue);
            int TotalRows = 0;
            this.ls = HRFunctions.Instance.Load_DocumentFindType(loai, PageSize, pIndex, out TotalRows);
            this.hTotalRows.Value = TotalRows.ToString();
        ...
        private void LoadProductType()
        {
            ...
            this.DdrDocumentType.DataSource = HRFunctions.Instance.SelectAll_DocumentType();
