...
<asp:Content ID="UISearchRouteMainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-group">
        <div class="row">
            <div class="d-flex justify-content-center mt-4" style="width: 100%">
                <div class="col-sm-10 ">
                    <div class="form-group">
                        <asp:DropDownList CssClass="form-control" AutoPostBack="true" ID="dlStartPosition"
                            runat="server" Style="width: 100% !important; max-width: 100% !important">
                        </asp:DropDownList>
                        <asp:DropDownList CssClass="form-control mt-1" AutoPostBack="true" ID="dlEndPosition"
                            runat="server" Style="width: 100% !important; max-width: 100% !important">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-sm-2 d-flex justify-content-center align-items-center">
                    <asp:Button
                        Style="height: 48px; background-color: teal; margin-bottom: 12px !important; color: white !important"
        ...
        <div class="row mt-4" style="padding-left: 8px; padding-right: 8px">
            <div class="col-sm-12 overflow-auto">
                ...
                <asp:GridView Visible="false" Style="width: 100%" OnRowDataBound="GridViewSearchRoute_RowDataBound"
                    ID="GridViewSearchRoute" CssClass="table table-bordered table-striped" runat="server"
                    AutoGenerateSelectButton="true"
                    OnSelectedIndexChanged="GridViewSearchRoute_SelectedIndexChanged"
                    SelectedRowStyle-BackColor="Teal" SelectedRowStyle-ForeColor="White">
                </asp:GridView>
            </div>
        ...
        <div class="row" style="padding-left: 8px; padding-right: 22px; height: 500px">
            <div class="col-sm-4 overflow-auto" style="height: 500px">
                <asp:GridView Visible="false" ID="GridViewSearchBusStop"
    ...
    <%-- Key ban thu AIzaSyDgD_ObQN_IIAO7L1zXqUkd2woTJETuJE0  --%>
            <script
