<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientUI.aspx.cs" Inherits="DocumentWebDemo.pages.ClientUI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="Panel1" runat="server">
    
        <asp:Label ID="Label1" runat="server" Text="Tra cứu văn bản"  style="margin-left:-10px; font-family:'Times New Roman', Times, serif;font-weight:bold;font-size:35px;" BorderColor="White" ForeColor="#38B47C"></asp:Label>
        <br />
    
            <asp:DropDownList style="margin-left:-10px; margin-top:10px; width: 100px; height:30px; border-radius:5px;" CssClass="custom-select" AutoPostBack="true" ID="dlPageNumber" runat="server"  BackColor="#38b47c" ForeColor="White" OnSelectedIndexChanged="dlPageNumber_SelectedIndexChanged">
       ...
       <div class="card-footer" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: small; font-weight: 600; font-style: normal; background-color: #FFFFFF; color: #000000">
            <asp:Panel ID="pnPhanTrang" runat="server">
                <div class="form-row">
                    <div class="col-auto">
                        <asp:Button ID="btTruoc" runat="server" BackColor="#48b47c" class="btn btn-dark"  OnClick="btPhanTrang_Click" ForeColor="White" Text="Trước" />
                        &nbsp;&nbsp;
                    ...
                    <div class="col-auto">
                         <asp:Button ID="btSau" runat="server" BackColor="#48b47c" class="btn  btn-dark"  OnClick="btPhanTrang_Click" ForeColor="White" Text="Sau" />
                    </div>
                </div>
            </asp:Panel>
        </div>
