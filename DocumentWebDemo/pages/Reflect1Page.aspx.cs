...
{
    public partial class Reflect1Page : System.Web.UI.Page
    {
        ...
        public List<Reflect> listPhanAnh;
        ...
        protected void AddBusButton_Click(object sender, EventArgs e)
        {
            ...
            else if (DocumentManagement.Instance.reflectFunc.Reflect_Select_Title(this.tieude.Value) == null)
            {
                ...
                DocumentManagement.Instance.reflectFunc.Reflect_InsertUpdate(reflect);
        ...
        private void LoadEditButton()
        {
            try
            {
                ...
                Reflect reflect = DocumentManagement.Instance.reflectFunc.Reflect_Select_ID(idEdit);
                if (reflect != null)
                {
                    ...
                    ReflectType reflectType = DocumentManagement.Instance.reflectTypeFunc.ReflectType_Select_ID(reflect.ReflectTypeID);
