<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentTypeUI.aspx.cs" Inherits="DocumentWebDemo.pages.DocumentTypeUI" %>
    ...
    <div class="card">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: large; font-weight: bold; background-color: #40b47c; color: #FFFFFF; margin: auto">Mã thể loại văn bản</th>
                                        <th style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: large; font-weight: bold; background-color: #40b47c; color: #FFFFFF; margin: auto">Tên loại văn bản</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=item.Name %></td>
                                         <td style="width: 100px">
                                            <a style="text-align: center" href="?idEdit=<%=item.DocumentTypeID %>" class="btn btn-warning">Sửa</a>
                                        </td>
                                       <td style="width: 40px; text-align: center">
                                            <input name='cbID' value='<%=item.DocumentTypeID %>' type='checkbox' /></td>
        ...
        <div class="card-footer" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: small; font-weight: 600; font-style: normal; background-color: #FFFFFF; color: #000000">
            <asp:Panel ID="pnPhanTrang" runat="server">
                <div class="grid">
                    <div class=".col-sm-1">
                        <asp:Button ID="btTruoc" runat="server" Text="Trước" class="btn btn-outline-dark" OnClick="btPhanTrang_Click" BackColor="#48b47c" ForeColor="White" />
                    </div>
                    <div class=".col-sm-1" style="color: #000000; margin-top:10px; margin-bottom:10px; background-color: #FFFFFF">
                    ...
                    <div class=".col-sm-1">
                        <asp:Button ID="btSau" runat="server" Text="Sau" class="btn btn-outline-dark" OnClick="btPhanTrang_Click" BackColor="#48b47c" ForeColor="White" />
                    </div>
                </div>
            </asp:Panel>
        </div>
