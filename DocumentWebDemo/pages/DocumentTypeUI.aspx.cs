    ...
    public partial class DocumentTypeUI : System.Web.UI.Page
    {
        ...
        protected void btXoa_Click(object sender, EventArgs e)
        {
            ...
            if (selected != null && selected.Trim().Length > 0)
            {
                ...
                DocumentManagement.Instance.typeFunc.Delete_IDs(list);
            }
        ...
        protected void btLuu_Click(object sender, EventArgs e)
        {
            ...
            DocumentManagement.Instance.typeFunc.InsertUpdate(obj);
        ...
        private void LoadEditButton()
        {
            try
            {
                ...
                DocumentType obj = DocumentManagement.Instance.typeFunc.Select_ID(idEdit);
                if (obj != null)
                {
        ...
        private void LoadTimKiem(int pIndex)
        {
            int PageSize = int.Parse(this.dlPageNumber.SelectedValue);
            int TotalRows = 0;
            this.ls = DocumentManagement.Instance.typeFunc.Find_KeyWord(this.txtKeyword.Value, PageSize, pIndex, out TotalRows);
